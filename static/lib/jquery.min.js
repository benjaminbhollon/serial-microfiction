...
!(function (e, t) {
  ...
  const t = []; const r = Object.getPrototypeOf; const s = t.slice; const g = t.flat ? function (e) { return t.flat.call(e); } : function (e) { return t.concat.apply([], e); }; const u = t.push; const i = t.indexOf; const n = {}; const o = n.toString; const v = n.hasOwnProperty; const a = v.toString; const l = a.call(Object); const y = {}; const m = function (e) { return typeof e === 'function' && typeof e.nodeType !== 'number'; }; const x = function (e) { return e != null && e === e.window; }; const E = C.document; const c = {
    ...
    let e; let d; let b; let o; let i; let h; let f; let g; let w; let u; let l; let T; let C; let a; let E; let v; let s; let c; let y; const S = `sizzle${1 * new Date()}`; const p = n.document; let k = 0; let r = 0; const m = ue(); const x = ue(); const A = ue(); const N = ue(); let D = function (e, t) { return e === t && (l = !0), 0; }; const j = {}.hasOwnProperty; let t = []; const q = t.pop; const L = t.push; let H = t.push; const O = t.slice; const P = function (e, t) { for (let n = 0, r = e.length; n < r; n++) if (e[n] === t) return n; return -1; }; const R = 'checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped'; const M = '[\\x20\\t\\r\\n\\f]'; const I = `(?:\\\\[\\da-fA-F]{1,6}${M}?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+`; const W = `\\[${M}*(${I})(?:${M}*([*^$|!~]?=)${M}*(?:'((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)"|(${I}))|)${M}*\\]`; const F = `:(${I})(?:\\((('((?:\\\\.|[^\\\\'])*)'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|${W})*)|.*)\\)|)`; const B = new RegExp(`${M}+`, 'g'); const $ = new RegExp(`^${M}+|((?:^|[^\\\\])(?:\\\\.)*)${M}+$`, 'g'); const _ = new RegExp(`^${M}*,${M}*`); const z = new RegExp(`^${M}*([>+~]|${M})${M}*`); const U = new RegExp(`${M}|>`); const X = new RegExp(F); const V = new RegExp(`^${I}$`); const G = {
      ...
      filter: {
        ...
        CHILD(h, e, t, g, v) {
          const y = h.slice(0, 3) !== 'nth'; const m = h.slice(-4) !== 'last'; const x = e === 'of-type'; return g === 1 && v === 0 ? function (e) { return !!e.parentNode; } : function (e, t, n) {
            let r; let i; let o; let a; let s; let u; let l = y !== m ? 'nextSibling' : 'previousSibling'; const c = e.parentNode; const f = x && e.nodeName.toLowerCase(); const p = !n && !x; let d = !1; if (c) {
              if (y) { while (l) { a = e; while (a = a[l]) if (x ? a.nodeName.toLowerCase() === f : a.nodeType === 1) return !1; u = l = h === 'only' && !u && 'nextSibling'; } return !0; } if (u = [m ? c.firstChild : c.lastChild], m && p) {
        ...
        PSEUDO(e, o) {
          let t; const a = b.pseudos[e] || b.setFilters[e.toLowerCase()] || se.error(`unsupported pseudo: ${e}`); return a[S] ? a(o) : a.length > 1 ? (t = [e,
            e,
            '',
            o], b.setFilters.hasOwnProperty(e.toLowerCase()) ? le((e, t) => { let n; const r = a(e, o); let i = r.length; while (i--)e[n = P(e, r[i])] = !(t[n] = r[i]); }) : function (e) { return a(e, 0, t); }) : a;
        },
      },
      pseudos: {
  ...
  }); let j; const q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/; (S.fn.init = function (e, t, n) {
    let r; let i; if (!e) return this; if (n = n || j, typeof e === 'string') {
      if (!(r = e[0] === '<' && e[e.length - 1] === '>' && e.length >= 3 ? [null,
        e,
        null] : q.exec(e)) || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e); if (r[1]) { if (t = t instanceof S ? t[0] : t, S.merge(this, S.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), N.test(r[1]) && S.isPlainObject(t)) for (r in t)m(this[r]) ? this[r](t[r]) : this.attr(r, t[r]); return this; } return (i = E.getElementById(r[2])) && (this[0] = i, this.length = 1), this;
    } return e.nodeType ? (this[0] = e, this.length = 1, this) : m(e) ? void 0 !== n.ready ? n.ready(e) : e(S) : S.makeArray(e, this);
  }).prototype = S.fn, j = S(E); const L = /^(?:parents|prev(?:Until|All))/; const H = {
    ...
    _default: [0,
      '',
      ''],
  }; function ve(e, t) { let n; return n = typeof e.getElementsByTagName !== 'undefined' ? e.getElementsByTagName(t || '*') : typeof e.querySelectorAll !== 'undefined' ? e.querySelectorAll(t || '*') : [], void 0 === t || t && A(e, t) ? S.merge([e], n) : n; } function ye(e, t) { for (let n = 0, r = e.length; n < r; n++)Y.set(e[n], 'globalEval', !t || Y.get(t[n], 'globalEval')); }ge.tbody = ge.tfoot = ge.colgroup = ge.caption = ge.thead, ge.th = ge.td, y.option || (ge.optgroup = ge.option = [1,
    ...
    let n; let a; let r = 0; const i = ft.prefilters.length; const s = S.Deferred().always(() => { delete u.elem; }); var u = function () {
      if (a) return !1; for (var e = tt || ut(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length; r < i; r++)l.tweens[r].run(n); return s.notifyWith(o, [l,
        n,
        t]), n < 1 && i ? t : (i || s.notifyWith(o, [l,
        1,
        0]), s.resolveWith(o, [l]), !1);
    }; var l = s.promise({
      elem: o,
      props: S.extend({}, e),
      ...
      stop(e) {
        let t = 0; const n = e ? l.tweens.length : 0; if (a) return this; for (a = !0; t < n; t++)l.tweens[t].run(1); return e ? (s.notifyWith(o, [l,
          1,
          0]), s.resolveWith(o, [l, e])) : s.rejectWith(o, [l, e]), this;
      },
    ...
    'show',
    'hide'], (e, r) => { const i = S.fn[r]; S.fn[r] = function (e, t, n) { return e == null || typeof e === 'boolean' ? i.apply(this, arguments) : this.animate(lt(r, !0), e, t, n); }; }), S.each({
    ...
    }).done(function (e) { o = arguments, a.html(r ? S('<div>').append(S.parseHTML(e)).find(r) : e); }).always(n && ((e, t) => {
      a.each(function () {
    ...
    'ajaxError',
    'ajaxSuccess',
    'ajaxSend'], (e, t) => { S.fn[t] = function (e) { return this.on(t, e); }; }), S.fn.extend({
